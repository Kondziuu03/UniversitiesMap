...
namespace UniversitiesApi.Migrations
{
    ...
    [Migration("20240430143104_FixRateEntity")]
    partial class FixRateEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniversitiesApi.Entities.Rate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UniversitiesApi.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UniversitiesApi.Entities.Rate", b =>
                {
                    b.HasOne("UniversitiesApi.Entities.University", "University")
                        .WithMany("Rates")
                        .HasForeignKey("UniversityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UniversitiesApi.Entities.User", "User")
                        .WithMany("Rates")
